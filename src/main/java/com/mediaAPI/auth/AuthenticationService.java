...
import com.mediaAPI.token.Token;
import com.mediaAPI.token.TokenRepository;
import com.mediaAPI.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    ...
    log.info("Сгенерирован токен {}", jwtToken);
  ...
  public User getCurrentUser () {
    ...
    return this.repository.findByUsername(currentPrincipalName).get();
  }
